...
const Flashcard = ({ term, definition }) => {
  ...
  return (
    <div className="w-64 h-48 bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 transform transition-transform duration-500 cursor-pointer hover:shadow-lg"
      onClick={handleClick}
    >
